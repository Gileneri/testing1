...
import net.mcreator.test.procedures.AllowBlueEnergyUIProcedure;
	...
	public static void eventHandler(RenderGuiEvent.Pre event) {
		...
		if (AllowBlueEnergyUIProcedure.execute(entity)) {
			if (HUDDisplayEnergy1Procedure.execute(entity)) {
				RenderSystem.setShaderTexture(0, new ResourceLocation("test:textures/screens/hud_ui_energy_blue_right.png"));
			...
			if (HUDDisplayEnergy2Procedure.execute(entity)) {
				RenderSystem.setShaderTexture(0, new ResourceLocation("test:textures/screens/hud_ui_energy_blue_left.png"));
