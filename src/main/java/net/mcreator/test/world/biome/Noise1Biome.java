...
public class Noise1Biome {
	public static final List<Climate.ParameterPoint> PARAMETER_POINTS = List.of(
			new Climate.ParameterPoint(Climate.Parameter.span(-0.9999f, -0.9999f), Climate.Parameter.span(-0.9999f, -0.9999f), Climate.Parameter.span(-0.16f, 1f), Climate.Parameter.span(-1.0001f, -1.0001f), Climate.Parameter.point(0.0f),
					Climate.Parameter.span(-1f, -0.35f), 0),
			new Climate.ParameterPoint(Climate.Parameter.span(-0.9999f, -0.9999f), Climate.Parameter.span(-0.9999f, -0.9999f), Climate.Parameter.span(-0.16f, 1f), Climate.Parameter.span(-1.0001f, -1.0001f), Climate.Parameter.point(1.0f),
					Climate.Parameter.span(-1f, -0.35f), 0));
