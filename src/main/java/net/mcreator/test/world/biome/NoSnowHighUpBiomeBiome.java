...
public class NoSnowHighUpBiomeBiome {
	public static Biome createBiome() {
		...
		biomeGenerationSettings.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION,
				PlacementUtils.register("test:tree_no_snow_high_up_biome",
						FeatureUtils.register("test:tree_no_snow_high_up_biome", Feature.TREE,
		...
		biomeGenerationSettings.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, PlacementUtils.register("test:grass_no_snow_high_up_biome", VegetationFeatures.PATCH_GRASS,
		...
		biomeGenerationSettings.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, PlacementUtils.register("test:flower_no_snow_high_up_biome", VegetationFeatures.FLOWER_DEFAULT,
