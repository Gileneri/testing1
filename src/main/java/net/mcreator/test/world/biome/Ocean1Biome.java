...
public class Ocean1Biome {

	public static final List<Climate.ParameterPoint> PARAMETER_POINTS = List.of(
			new Climate.ParameterPoint(Climate.Parameter.span(-0.5f, 0.5f), Climate.Parameter.span(-0.5f, 0.5f), Climate.Parameter.span(-1f, -0.16f), Climate.Parameter.span(0.9999f, 0.9999f), Climate.Parameter.point(0.0f),
					Climate.Parameter.span(0.35f, 1f), 0),
			new Climate.ParameterPoint(Climate.Parameter.span(-0.5f, 0.5f), Climate.Parameter.span(-0.5f, 0.5f), Climate.Parameter.span(-1f, -0.16f), Climate.Parameter.span(0.9999f, 0.9999f), Climate.Parameter.point(1.0f),
					Climate.Parameter.span(0.35f, 1f), 0));
